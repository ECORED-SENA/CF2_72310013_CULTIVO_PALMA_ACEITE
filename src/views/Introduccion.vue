  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5
      .col-lg-9.mb-4.mb-lg-0.bg-color-1.p-4(data-aos="fade-right")
        p.mb-0 El cultivo de la palma de aceite se reconoce como una actividad agrícola de gran importancia productiva, cuyo éxito depende de la adecuada aplicación de prácticas técnicas desde el mantenimiento del cultivo hasta la cosecha del fruto. Las labores de mantenimiento comprenden un conjunto de actividades orientadas a garantizar el crecimiento y desarrollo óptimo de las palmas, entre ellas el control de malezas, el manejo integrado de plagas y enfermedades, la nutrición vegetal, el manejo del agua y la poda, acciones que contribuyen a conservar la sanidad del cultivo y a optimizar su productividad.     
      .col-lg-3(data-aos="fade-left")
        figure
          img(src="@/assets/curso/intro/1.png", alt="", style="width: 450px").m-auto
    .bloque-texto-g.bloque-texto-g.bg-color-2.p-3.p-sm-4.p-md-5.mb-5(data-aos="fade-right")
          .bloque-texto-g__img(
    ...
    .row.mb-5.align-items-center
      ...
      .col-2.bg-color-4.d-none.d-xl-block
        figure
          img(src="@/assets/curso/intro/3.svg", data-aos="zoom-in", style="width: 110px").mx-auto
</template>
